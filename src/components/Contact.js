          ...
          <Stack spacing={4} as={Container} maxW={"3xl"} textAlign={"center"}>
            ...
            <Center>
              <HStack pt={4} spacing={4}>
                <FaLinkedin className="social-icon" onClick={linkedin} size={28} />
                <FaGithub className="social-icon" onClick={github} size={28} />
                <FaEnvelope className="social-icon" onClick={email} size={28} />
              </HStack>
            </Center>
          </Stack>
        </Stack>
